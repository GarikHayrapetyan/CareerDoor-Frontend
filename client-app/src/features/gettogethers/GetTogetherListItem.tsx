    ...
    return(
            <Segment.Group size='tiny'>
                <Segment>
                    <Item.Group>
                        <Item>
                            <Icon name='save outline' style={{position:'absolute',right:'30px'}} size='large'/>
                ...
                <Segment>
                    <span>
                        <Icon name='calendar alternate outline'/> {getTogether.date}
                        <Icon name='clock outline' style={{marginLeft:'5px'}}/> 19:30
                    </span>
                </Segment>
                <Segment secondary>
                    Attendances... 
