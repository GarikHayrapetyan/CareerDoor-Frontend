    ...
    return (
        <>
            ...
            <Segment attached style={{ paddingRight: '0px' }}>
                <List relaxed divided style={{ height: '190px', overflowY: 'scroll', marginRight: '14px', marginLeft: '6px' }}>
                    {attendees.map(attendee => (
                        <Item 
                        id='segmentt'
                        style={{ position: 'relative', width: '92%', height: '33%', display: 'flex', alignItems: 'center' }} 
                        key={attendee.username}>
                            {attendee.username === host?.username &&
                                <Label
                                    style={{ position: 'absolute', top: '8px', left: '100%' }}
                                    color='orange'
                                    ribbon='right'
                                    size='tiny'
                                >
